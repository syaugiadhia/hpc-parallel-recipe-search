...
echo ============================================================
echo  SETUP SLAVE 1 MS-MPI  (sesi dijalankan sebagai %CLUSTER_USER%)
echo ============================================================
...
echo.
echo Menjalankan smpd + GUI sebagai akun cluster '%CLUSTER_USER%' (Slave, %S1_SLOTS% slot, auto-start)...
